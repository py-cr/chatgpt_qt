    ...
    def get_init_functions(cls):
        ...
        return {
            ...
            "心理咨询": {
                ...
                "Suffix": "",
                "Sample": "现在我想[和你聊一下关于工作上的问题，工作繁忙太累，如果不工作就没有收入]，怎么办",
                "ButtonStyle": "background-color: blue; color: white"
            },
            "周易解梦": {
            ...
            "智囊团建议": {
                ...
                "Suffix": "",
                "Sample": "我的处境是：[用户对产品的某些功能提出了意见和建议，但是我认为这些功能不是产品的关键点]，我的决策是：[仔细考虑用户提出的意见并尝试在关键点上做出妥协，同时向用户解释产品设计理念。]",
                "ButtonStyle": "background-color: aquamarine; color: black"
            }
        }
